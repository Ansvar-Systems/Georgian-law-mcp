...
Georgian law database for cybersecurity compliance via Model Context Protocol (MCP).
...
### Claude Code (Remote)
```bash
claude mcp add georgian-law --transport http https://georgian-law-mcp.vercel.app/mcp
```
