...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (სამართლებრივი კონსულტაციის ურთიერთობა)
...
If you are a lawyer (ადვოკატი), legal researcher, or other legal professional:

- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (პროფესიული პასუხისმგებლობა)
...
- **Professional Rules**: Members of the Georgian Bar Association (საქართველოს ადვოკატთა ასოციაცია) must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (Legislative Herald of Georgia — matsne.gov.ge)
2. Verifying the provision is currently in force and has not been amended
3. Reading the full context of cited provisions
4. Consulting case law and explanatory materials for interpretation
...
This Tool aggregates data from official Georgian legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **matsne.gov.ge (Legislative Herald of Georgia)** | Authoritative | Statute text, official gazette (primary reference) |
| **Community/open-data sources** | Supplementary | Cross-references, metadata (verify independently) |
| **Council of Europe / treaty databases** | Authoritative for international law | Council of Europe conventions, bilateral treaties |
...
For professional legal work, **always cross-check with authoritative sources**. These services provide editorial oversight, comprehensive annotations, and professional-grade currency guarantees that this Tool **cannot** provide.
...
- Georgian law changes continuously through new statutes, amendments, and court decisions
...
- Even "fresh" data may be outdated if recent amendments were published on matsne.gov.ge
...
1. **Complete case law** -- Coverage of the Supreme Court of Georgia (საქართველოს უზენაესი სასამართლო), Constitutional Court (საკონსტიტუციო სასამართლო), and lower court decisions is limited
...
4. **Unpublished decisions** -- Administrative rulings largely absent
5. **Full legislative history** -- Limited coverage of parliamentary materials and explanatory notes (განმარტებითი ბარათი)
...
- **International Law Blind Spots**: Cannot fully assess Council of Europe obligations or international treaty compliance
...
- This includes but is not limited to:
  ...
  - Regulatory sanctions from bar authorities
  - Reputational damage
...
This Tool uses **algorithmic search and ranking** methods. It is NOT a high-risk "administration of justice" system.
...
2. **Official Verification**: Cross-check ALL results with official sources (matsne.gov.ge)
3. **Professional Judgment**: Apply independent legal analysis and professional judgment
4. **Document Sources**: Cite official sources in legal work, not this Tool
5. **Update Check**: Before finalizing legal work, check for recent amendments and decisions

## Changes to This Disclaimer

This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Georgian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Georgian-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (matsne.gov.ge)
...
- **COMPLY** with Georgian Bar Association (საქართველოს ადვოკატთა ასოციაცია) professional ethics rules regarding AI tool use and client confidentiality
