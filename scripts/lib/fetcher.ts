/**
 * Rate-limited HTTP client for Georgian legislation from the Sejm ELI API.
 *
...
const USER_AGENT = 'Georgian-Law-MCP/1.0 (https://github.com/Ansvar-Systems/georgian-law-mcp; hello@ansvar.ai)';
